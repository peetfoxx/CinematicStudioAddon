 ...
 *
 * Feature 1 (this release): make `play`/`stop` reliably target a specific player even when the
 ...
 *
 * Planned: a self-contained actor layer (Citizens / packet NPCs) synced to cinematic playback,
 * to replace CinematicStudio's unreliable built-in actors.
 */
